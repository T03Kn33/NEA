...
no_of_loops = int(inputValidation_int("number of loops")) 
...
if __name__ == "__main__": 
    ...
    mass_entry.insert(0,f"{cubePhysics.mass}") 
    ...
    charge_entry.insert(0,f"{cubePhysics.charge}") 
    ...
    gap_entry.insert(0,f"{plates.gap}") 
    ...
    rho_entry.insert(0,f"{dielectric.rho}") 
    ...
    w_entry.insert(0,f"{cubePhysics.w}") 
